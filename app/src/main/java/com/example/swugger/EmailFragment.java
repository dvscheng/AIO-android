...
public class EmailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            Gmail service = buildAuthorizedApiClientService();
            ListMessagesResponse response = service.users().messages().list("me").setQ("").execute();
            ...
            while (response.getMessages() != null) {
                ...
                if (response.getNextPageToken() != null) {
                    ...
                    response = service.users().messages().list("me").setQ("")
            ...
            for (Message message : messages) {
                Log.i("gmail_api",message.toPrettyString());
            }
...
//    private static final String CREDENTIALS_FILE_PATH = "/credentials.json";
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        ...
        GoogleAuthorizationCodeFlow flow = new GoogleAuthorizationCodeFlow.Builder(
                HTTP_TRANSPORT, JSON_FACTORY, clientSecrets, G_SCOPES)
    ...
    private Gmail buildAuthorizedApiClientService() throws IOException, GeneralSecurityException {
...
//        final NetHttpTransport HTTP_TRANSPORT = GoogleNetHttpTransport.newTrustedTransport();
    ...
    private boolean isDeviceOnline() {
        ConnectivityManager connMgr =
                (ConnectivityManager) getActivity().getSystemService(Context.CONNECTIVITY_SERVICE); // no getActivity
    ...
    private boolean isGooglePlayServicesAvailable() {
        ...
        final int connectionStatusCode =
                apiAvailability.isGooglePlayServicesAvailable(this.getContext()); // this
    ...
    private void chooseAccount() {
        if (EasyPermissions.hasPermissions(
                getContext(), Manifest.permission.GET_ACCOUNTS)) {  // this instead of getContext()
            String accountName = getActivity().getPreferences(Context.MODE_PRIVATE) // no getActivity
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                            ...
                            EmailFragment.REQUEST_AUTHORIZATION);
                } else {
